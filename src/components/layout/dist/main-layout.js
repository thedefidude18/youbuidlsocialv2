    ...
    return (React.createElement(tooltip_1.TooltipProvider, null,
        React.createElement("div", { className: "min-h-screen bg-background" },
            ...
            React.createElement("div", { className: "flex " + (showHeader ? 'pt-14 md:pt-16' : 'pt-0') },
                ...
                React.createElement("div", { className: "hidden lg:block w-64 xl:w-72 shrink-0" },
                    React.createElement("div", { className: "fixed " + (showHeader ? 'top-16' : 'top-0') + " bottom-0 w-64 xl:w-72 overflow-y-auto border-l border-border py-8 px-4" },
