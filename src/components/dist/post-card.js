...
var donate_modal_1 = require("@/components/donate-modal");
...
function PostCard(_a) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(donate_modal_1.DonateModal, { isOpen: showDonateModal, onClose: function () { return setShowDonateModal(false); }, author: post.author, streamId: post.id, postExcerpt: post.content })));
}
